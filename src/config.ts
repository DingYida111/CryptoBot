...
const BaseEnvSchema = z.object({
  ...
  CHOP_GRID_SPACING_PCT: z.coerce.number().positive().default(0.0025),
  CHOP_GRID_ORDER_SIZE: z.coerce.number().int().positive().default(1),
  CHOP_GRID_MAX_INVENTORY: z.coerce.number().int().positive().default(6),
  CHOP_GRID_RECENTER_PCT: z.coerce.number().positive().default(0.006),
  CHOP_GRID_BREAKOUT_PCT: z.coerce.number().positive().default(0.012),
