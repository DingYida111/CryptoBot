...
const BaseEnvSchema = z.object({
  ...
  CHOP_GRID_LAYERS: z.coerce.number().int().positive().default(6),
  CHOP_GRID_SPACING_PCT: z.coerce.number().positive().default(0.005),
  CHOP_GRID_ORDER_SIZE: z.coerce.number().int().positive().default(1),
  CHOP_GRID_SEED_MULTIPLIER: z.coerce.number().int().positive().default(6),
