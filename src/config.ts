...
const BaseEnvSchema = z.object({
  ...
  CHOP_GRID_LAYERS: z.coerce.number().int().positive().default(3),
  CHOP_GRID_SPACING_PCT: z.coerce.number().positive().default(0.01),
  CHOP_GRID_ORDER_SIZE: z.coerce.number().int().positive().default(1),
  CHOP_GRID_SEED_MULTIPLIER: z.coerce.number().int().positive().default(4),
  CHOP_GRID_MAX_INVENTORY: z.coerce.number().int().positive().default(12),
  CHOP_GRID_RECENTER_PCT: z.coerce.number().positive().default(0.02),
