...
const BaseEnvSchema = z.object({
  ...
  CHOP_GRID_SEED_MULTIPLIER: z.coerce.number().int().positive().default(3),
  CHOP_GRID_MAX_INVENTORY: z.coerce.number().int().positive().default(9),
  CHOP_GRID_RECENTER_PCT: z.coerce.number().positive().default(0.012),
  CHOP_GRID_BREAKOUT_PCT: z.coerce.number().positive().default(0.025),
