...
module.exports = {
  apps: [
    ...
    {
      name: "cryptobot-daily-notify",
      script: "dist/scripts/daily_pnl_notify.js",
      cwd: __dirname,
      cron_restart: "0 22 * * *",
      autorestart: false,
      watch: false,
      env: { NODE_ENV: "production" },
      out_file: "logs/daily-notify.out.log",
      error_file: "logs/daily-notify.log",
      merge_logs: true,
      max_memory_restart: "128M",
    },
    {
      name: "cryptobot-live-executor",
      script: "dist/runtime/run_runtime_action_executor.js",
      args: "--live --ack-dry-run 10",
      cwd: __dirname,
      watch: false,
      autorestart: true,
      ...
      min_uptime: "5s",
      env: { NODE_ENV: "production" },
      out_file: "logs/live-executor.out.log",
      error_file: "logs/live-executor.log",
      merge_logs: true,
      max_memory_restart: "128M",
      kill_timeout: 5000,
    },
